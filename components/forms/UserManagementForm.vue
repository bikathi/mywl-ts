<template>
	<form
		...
		method="post"
		class="flex">
		<div class="w-1/3 flex-grow"></div>
		<div class="w-2/3 flex-grow">
			<h3 class="my-2 text-2xl font-bold text-gray-800 dark:text-white">
				Basic Information
			</h3>
			...
			<div class="flex flex-col lg:flex-row space-x-0 lg:space-x-4 mt-4">
				<div class="w-full lg:w-1/2">
					<label
						for="user-id"
						class="block text-sm font-medium mb-1 dark:text-white"
			...
			<div class="w-full mt-4">
				...
				<select
					...
					<option selected>Select from Available Roles</option>
